...
const SearchCourse = () => {
    ...
    const searchInput = (e) => {
        ...
        const ViewSearch = async () => { 
            await axios.get(`http://localhost:5000/records/course/search/${id}`)
            .then((res) => res.data)
                  ...
                  <div className="listitem">
                    <p>
                      <Button
                        color="inherit"
                        LinkComponent={Link}
                        to={`/course/view/${record._id}`}
                      >
                        <Typography>
                          {record.id}. {record.name} {record.year} 
                        </Typography>
                      </Button>
                    </p>
                    <div className="changeButton">
                      <Grid container spacing={1}>
                        ...
                        <Grid item xs={3}>
                          <Link to={`/course/view/${record._id}`}>
